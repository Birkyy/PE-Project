...
const Dashboard = () => {
  ...
  const generateNotifications = () => {
    ...
    projectDistribution.forEach((project, index) => {
      if (project.value === 100) {
        notifications.push({
          id: `completed-${project.name}-${index}`,
      ...
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          <div
            ...
            } border rounded-lg p-6 hover:shadow-lg ${
              darkMode
          ...
          <div
            className={`${
              ...
              darkMode ? "hover:shadow-cyan-500/20" : "hover:shadow-cyan-300/30"
            } transition-all duration-300`}
          >
            <div className="flex items-center justify-between">
              <div>
          ...
          <div
            className={`${
              ...
              darkMode ? "hover:shadow-red-500/20" : "hover:shadow-red-300/30"
            } transition-all duration-300`}
          >
            <div className="flex items-center justify-between">
              <div>
                  ...
                  {upcomingTasks.length > 0 ? (
                    upcomingTasks.map((task) => (
                      <div
                        ...
                        className={`flex items-center justify-between p-3 rounded-lg border cursor-pointer hover:shadow-md transition-all duration-200 ${
                          darkMode
                ...
                <div className="space-y-6">
                  {notifications.map((item, index) => (
                    <div key={item.id} className="relative flex items-start">
                      {/* Notification dot */}
                      <div
                        className={`relative z-10 w-3 h-3 rounded-full border-2 ${getNotificationStatusColor(
                          item.status
                        )} ${
