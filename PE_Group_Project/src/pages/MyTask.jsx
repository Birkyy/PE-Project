...
const MyTask = () => {
  ...
  const handleDeleteTask = async () => {
    ...
    try {
      ...
      setTodoTasks((prev) => prev.filter((t) => t.id !== taskToDelete.id));
      setInProgressTasks((prev) => prev.filter((t) => t.id !== taskToDelete.id));
      setCompletedTasks((prev) => prev.filter((t) => t.id !== taskToDelete.id));
      showNotification(`Task "${taskToDelete.title}" has been deleted successfully.`, 'success');
